...
SUPPORTED_EXTENSIONS = {
    ".tiff", ".tif",          # 16-bit thermal
    ".npy",                   # NumPy arrays (simulation output)
    ".raw", ".bin",           # Raw binary sensor dumps
    ".png", ".jpg", ".jpeg",  # Standard images
    ".bmp", ".webp",          # Other raster
}
...
def load_frame(path: str,
    ...
    if ext in (".raw", ".bin"):
        ...
        if raw.size >= h * w:
            ...
            # Unknown shape — try to infer square
